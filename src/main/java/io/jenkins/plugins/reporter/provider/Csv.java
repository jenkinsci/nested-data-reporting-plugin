...
public class Csv extends Provider {
    ...
    public ReportParser createParser() {
        ...
        return new CsvCustomParser(getActualId(), getDelimiter());
    }
    ...
    public static class CsvCustomParser extends ReportParser {
        ...
        public CsvCustomParser(String id, char delimiter) {
            super();
            this.id = id;
        ...
        public ReportDto parse(File file) throws IOException {
            ...
            final CsvSchema schema = mapper.schemaFor(String[].class).withColumnSeparator(getDelimiter());
